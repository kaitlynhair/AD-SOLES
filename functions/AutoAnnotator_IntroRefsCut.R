  ...
  function(link,
    ...
    CleanText <-
      function(text,
        ...
        if (newLine == T)
          text<-
            gsub("(Introduction|INTRODUCTION|Background|BACKGROUND)\r\n[\\W\\S\\s]+?(METHODS|METHODOLOGY|Methods|Materials and methods|methods|Methodology|Experimental [Pp]rocedures|EXPERIMENTAL PROCEDURES|Experimental [Pp]rotocol|EXPERIMENTAL PROTOCOL|Results|RESULTS)\r\n",
                 "",
                 text,
                 perl = T) 
